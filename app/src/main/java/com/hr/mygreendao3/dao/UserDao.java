...
public class UserDao extends AbstractDao<User, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Dogid = new Property(2, long.class, "dogid", false, "DOGID");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USER\" (" + //
                ...
                "\"NAME\" TEXT," + // 1: name
                "\"DOGID\" INTEGER NOT NULL );"); // 2: dogid
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, User entity) {
        ...
        stmt.bindLong(3, entity.getDogid());
    }
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setDogid(cursor.getLong(offset + 2));
     }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getDogDao().getAllColumns());
            builder.append(" FROM USER T");
            builder.append(" LEFT JOIN DOG T0 ON T.\"DOGID\"=T0.\"_id\"");
            builder.append(' ');
    ...
    protected User loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        Dog dog = loadCurrentOther(daoSession.getDogDao(), cursor, offset);
         if(dog != null) {
            entity.setDog(dog);
        }
