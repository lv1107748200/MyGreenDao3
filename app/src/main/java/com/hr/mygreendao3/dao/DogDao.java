...
public class DogDao extends AbstractDao<Dog, Long> {
    ...
    private Query<Dog> peo_DogsQuery;
    ...
    /** Internal query to resolve the "dogs" to-many relationship of Peo. */
    public List<Dog> _queryPeo_Dogs(Long id) {
        synchronized (this) {
            if (peo_DogsQuery == null) {
                QueryBuilder<Dog> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.Id.eq(null));
                peo_DogsQuery = queryBuilder.build();
            }
        }
        Query<Dog> query = peo_DogsQuery.forCurrentThread();
